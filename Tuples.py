...
#using merge of tuple with the + operater you can add an elemnt and it will create a new tuple
tuplex = tuplex + (9,)
print(tuplex)
...
#is exclusive
print(_slice)
#if the start index is'nt defined, is taken form the beg inning of the tuple
slice = tuplex[:6]
print(_slice)