...
rect1_width, rect1_height = 150,250
...
center2_x = top_left1[0] + rect1_width // 2 
center2_y = top_left1[1] + rect1_width // 2 
...
cv2.putText(image_rgb, 'Center 1', (top_left1[40], center1_x + 40), font, 0.6, (0, 255, 0), 2, cv2.LINE_AA)
cv2.putText(image_rgb, 'Center 2', (top_left2[40], center2_x + 40), font, 0.6, (0, 255, 0), 2, cv2.LINE_AA)
